...
function AddProduct(){
    ...
    return <div className="add-product">
        <div className="addproduct-itemfield">
            ...
            <p>Seller Name</p>
            <input value={productDetails.seller_name} onChange={(event)=>changeHandler(event)} type="text" name="seller_name" placeholder='Type here'  />
            <p>Contact Number</p>
            <input value={productDetails.contact} onChange={(event)=>changeHandler(event)} type="text" name="contact" placeholder='Type here'  />
        </div>
